                ...
                <div className={styles.chatContainer}>
                    {!lastQuestionRef.current ? (
                        <div className={styles.chatEmptyState}>
                            ...
                            <img
                                        src="https://content.sportslogos.net/logos/31/701/full/howard_bison_logo_secondary_20154240.png"
                                        alt="Howard Bison"
                                        width="120px"
                                        height="120px"
                                    />
                            <h1 className={styles.chatEmptyStateTitle}>Learn About Howard University</h1>
